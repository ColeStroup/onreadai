      ...
      <div className="mx-auto w-full max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <SectionHeading
            ...
            title="Everything needed to understand, fix, and verify."
            description="Each output serves a distinct step, from choosing the next website task to sharing evidence and checking the result."
          />
          <Link
            href="/example-report"
