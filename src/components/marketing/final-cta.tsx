...
export function FinalCta() {
  return (
    <section aria-labelledby="final-cta-heading" className="bg-teal-300 py-16 text-[#052b27] sm:py-20">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
        <div className="max-w-3xl">
          ...
          <h2 id="final-cta-heading" className="mt-4 text-4xl font-semibold leading-tight sm:text-5xl">Find your next growth move.</h2>
          <p className="mt-4 max-w-2xl text-base leading-7 text-[#174b47] sm:text-lg">
            Run your first audit and see what deserves attention, why it matters,
            and how to begin fixing it.
          </p>
        </div>
      ...
      <p className="mx-auto mt-5 w-full max-w-7xl px-6 text-sm text-[#35635f] lg:px-8">No credit card required.</p>
    </section>
  );
}
